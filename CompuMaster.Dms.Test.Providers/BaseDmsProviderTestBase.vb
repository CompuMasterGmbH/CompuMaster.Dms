...
Public MustInherit Class BaseDmsProviderTestBase
    ...
    <Test> Public Async Function ListRemoteItemAsync() As Threading.Tasks.Task
        Dim DmsProvider As CompuMaster.Dms.Providers.BaseDmsProvider = Me.LoggedInDmsProvider
        Dim Item As DmsResourceItem

        Assert.Catch(Of System.ArgumentNullException)(Async Sub()
                                                       Await DmsProvider.ListRemoteItemAsync(Nothing)
                                                   End Sub)
        Item = Await DmsProvider.ListRemoteItemAsync(DmsProvider.BrowseInRootFolderName)
        ...
        Item = Await DmsProvider.ListRemoteItemAsync(DmsProvider.DirectorySeparator)
        System.Console.WriteLine(Item)
        Assert.NotNull(Item)
        Assert.AreEqual(DmsResourceItem.ItemTypes.Root, Item.ItemType)
        Assert.AreEqual("", Item.Folder)
        ...
        Item = Await DmsProvider.ListRemoteItemAsync("")
        System.Console.WriteLine(Item)
        Assert.NotNull(Item)
        Assert.AreEqual(DmsResourceItem.ItemTypes.Root, Item.ItemType)
        Assert.AreEqual("", Item.Folder)
        ...
        For Each RemoteFolder As String In Me.RemoteFoldersMustExist
            Item = Await DmsProvider.ListRemoteItemAsync(RemoteFolder)
            System.Console.WriteLine(Item)
            Assert.NotNull(Item)
        ...
        For Each RemoteFile As String In Me.RemoteFilesMustExist
            Item = Await DmsProvider.ListRemoteItemAsync(RemoteFile)
            System.Console.WriteLine(Item)
            Assert.NotNull(Item)
        ...
        Item = Await DmsProvider.ListRemoteItemAsync("not-found")
        System.Console.WriteLine(Item)
        Assert.Null(Item)
        For Each RemoteItem As String In Me.RemoteItemsMustNotExist
            Item = Await DmsProvider.ListRemoteItemAsync(RemoteItem)
            System.Console.WriteLine(Item)
            Assert.Null(Item)
        Next
    ...
    <Test> Public Async Function ListAllRemoteItemsAsync() As Threading.Tasks.Task
        Dim DmsProvider As CompuMaster.Dms.Providers.BaseDmsProvider = Me.LoggedInDmsProvider
        Dim Items As List(Of DmsResourceItem)

        Items = Await DmsProvider.ListAllRemoteItemsAsync(DmsProvider.BrowseInRootFolderName, BaseDmsProvider.SearchItemType.AllItems)
        ...
        For Each RemoteFolder As String In Me.RemoteFoldersMustExist
            Items = Await DmsProvider.ListAllRemoteItemsAsync(RemoteFolder, BaseDmsProvider.SearchItemType.AllItems)
            For Each MyItem As DmsResourceItem In Items
                System.Console.WriteLine(MyItem.ToString & " [ETag/ProvderSpecificHash: " & MyItem.ProviderSpecificHashOrETag & "] [Last Modification: " & MyItem.LastModificationOnLocalTime.GetValueOrDefault.ToString("yyyy-MM-dd HH:mm:ss") & "]")
    ...
    <Test> Public Async Function RemoteItemExistsAsync() As Threading.Tasks.Task
        Dim DmsProvider As CompuMaster.Dms.Providers.BaseDmsProvider = Me.LoggedInDmsProvider
        For Each MustNotExistItem As String In Me.RemoteItemsMustNotExist
            Assert.IsFalse(Await DmsProvider.RemoteItemExistsAsync(MustNotExistItem))
        Next
        For Each MustNotExistItem As String In Me.RemoteFilesMustExist
            Assert.IsTrue(Await DmsProvider.RemoteItemExistsAsync(MustNotExistItem))
        Next

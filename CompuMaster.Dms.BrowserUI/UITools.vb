...
Friend Class UITools
    ...
    Public Shared Sub SwitchToolStripVisibility(item As ToolStripItem, visible As Boolean, bold As Boolean)
    ...
    Public Shared Sub SwitchSeparatorLinesVisibility(menu As ToolStripItemCollection)
